...
- (void)subviewsUpdate
{
    self.logoImageView.frame = CGRectMake(UMSocial_Name_Label_Height/2+5, 5, self.frame.size.width-UMSocial_Name_Label_Height-10, self.frame.size.height - UMSocial_Name_Label_Height-10);
