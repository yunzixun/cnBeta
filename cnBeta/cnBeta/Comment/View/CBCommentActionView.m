...
@implementation CBCommentActionView
...
- (void)setup
{
    _supportButton = [[CBCellButton alloc] initWithFrame:CGRectMake(10, 5, 55, 28)];
    ...
    _opposeButton = [[CBCellButton alloc] initWithFrame:CGRectMake(80, 5, 55, 28)];
    ...
    _replyButton = [[CBCellButton alloc] initWithFrame:CGRectMake(150, 10, 30, 18)];
    [_replyButton setTitle:@"回复" forState:UIControlStateNormal];
    [_replyButton setTitleColor:[UIColor cb_textColor] forState:UIControlStateNormal];
