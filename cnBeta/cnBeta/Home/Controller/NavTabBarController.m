...
//    self.navigationItem.backBarButtonItem = backItem;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(configBackgroundColor) name:CBAppSettingThemeChangedNotification object:nil];
...
- (void)initSubViewControllers
{
    ...
    CBNewsListViewController *newsTvc = [[CBNewsListViewController alloc]init];
...
- (void)initConfig
{
    ...
    viewController.view.frame = CGRectMake(0, 0, ScreenWidth, ScreenHeight - 64);
    
    [_mainView addSubview:viewController.view];
    [self addChildViewController:viewController];
    
    _linev = [[UIView alloc]initWithFrame:CGRectMake(0, 64, ScreenWidth, 1)];
...
{
    _mainView.backgroundColor = [UIColor cb_navTabMainViewBackgroundColor];
    _linev.backgroundColor = [UIColor cb_lineViewBackgroundColor];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    viewController.view.frame = CGRectMake(_currentItemIndex * ScreenWidth, 0, ScreenWidth, ScreenHeight - 64);
    [_mainView addSubview:viewController.view];
    [self addChildViewController:viewController];
}
