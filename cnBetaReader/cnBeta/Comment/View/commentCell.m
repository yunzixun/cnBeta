...
- (void)setFlooredCommentItem:(flooredCommentModel *)flooredCommentItem
{
    ...
    _commentView.backgroundColor = [UIColor cb_backgroundColor];
    //_commentView = commentView;
    
    for (UIView *view in _commentActionView.subviews) {
        [view removeFromSuperview];
    }
    CBCommentActionView *commentActionView = [[CBCommentActionView alloc] initWithFrame:CGRectMake(0, 0, 240, 25)];
    ...
    _commentActionView.backgroundColor = [UIColor cb_backgroundColor];
    
    
}

- (void)setCommentActions:(CBCommentActionView *)commentActionView
{
    //commentActionView.backgroundColor = [UIColor cb_backgroundColor];
